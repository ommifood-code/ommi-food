...
openCustomerMealOrder=async function(token){
 ...
 if(['rejected','cancelled'].includes(o.status)){box.append(mealAction('البحث عن مطبخ آخر بنفس الطلب',async()=>{requestDraft={dish:o.dish_name,people:o.people,requested_at:o.requested_at?requestDraftTime(localMealValue(o.requested_at)):'',name:o.customer_name,phone:o.customer_phone,notes:o.notes,fulfilment:o.fulfilment};showScreen('chefs');await loadChefs();}));}
