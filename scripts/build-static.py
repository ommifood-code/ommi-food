...
out.mkdir()
for name in ['index.html','admin.html','terms.html','style.css','dish-images.css','meal-orders.css','simple-launch.css','app.js','dish-images.js','meal-orders.js','nearby.js','simple-launch.js','kitchen-settings.js','kitchen-overview.js','food-requests.js','navigation-state.js','food-request-admin.js','admin.js','admin-orders.js','_headers']:
