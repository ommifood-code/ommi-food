...
function cleanName(v){return (v||'').replace(/^(أمّي|أمي|امي|عمّي|عمي|Ommi|Oncle)\s*/i,'').trim()}
...
document.querySelectorAll('[data-open-join]').forEach(b=>b.addEventListener('click',()=>openModal(joinModal)));
